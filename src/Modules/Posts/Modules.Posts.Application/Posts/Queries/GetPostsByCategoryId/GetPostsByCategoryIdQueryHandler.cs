...
{
    public class GetPostsByCategoryIdQueryHandler : IRequestHandler<GetPostsByCategoryIdQuery, Response<IQueryable<PostPayload>>>
    {
        ...
        public Task<Response<IQueryable<PostPayload>>> Handle(GetPostsByCategoryIdQuery request, CancellationToken cancellationToken)
        {
